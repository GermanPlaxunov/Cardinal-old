...
public class StocksDivider {
     ...
     */
    public List<List<CoreStockEntity>> divideStocksOnPeriods(String symbol, List<CoreStockEntity> stocks) {
        ...
        var periods = new ArrayList<List<CoreStockEntity>>();
     ...
     */
    private List<CoreStockEntity> getNextPeriod(List<CoreStockEntity> stocks, LocalDateTime from, LocalDateTime to) {
